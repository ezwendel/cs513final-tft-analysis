...
saveRDS(C50_class, "./86ft_c50.rds")
c50Model <- readRDS("./86ft_c50.rds")
...
saveRDS(CART_class, "./86ft_CART.rds")
cartModel <- readRDS("./86ft_CART.rds")
...
saveRDS(nBayes_all, "./86ft_nb.rds")
nbModel <- readRDS("./86ft_nb.rds")
...
sqrt(nrow(training))
# 216
predict_k215 <- kknn(formula=top4~., training, test[,-1], k=215,kernel ="triangular" )
...
saveRDS(predict_k215, "./86ft_knn.rds")
knnModel <- readRDS("./86ft_knn.rds")
...
ann <-compute(net_wisc_bc , test[,-1])
ann$net.result 
...
saveRDS(net_wisc_bc, "./86ft_nn.rds")

model <- readRDS('./86ft_nn.rds')
