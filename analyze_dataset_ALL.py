...
X = pd.read_csv('./finalDataALL/all_data.csv')

# 112 is match_id, 113 is placement, 114 is top4
Y = X.iloc[:, 114]
X.drop(['match_id', 'placement', 'top4'], axis=1, inplace=True)
...
# df_pca.to_csv('./finalDataALL/pca_data.csv', index=False)