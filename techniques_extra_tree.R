...
# read in data
data <- read.csv("C://Users//elijah//Desktop//cs513final//finalData//all_data.csv", na.strings="?")

most_important <- c(70, 66, 62, 69, 2, 14, 0, 16, 17, 28, 3, 8, 4, 1,  5,  6, 76, 73, 67, 13)
most_important <- most_important + 4
most_important <- c(most_important, 3)
...
saveRDS(C50_class, "./extra_tree_C50.rds")
c50Model <- readRDS("./extra_tree_C50.rds")
...
saveRDS(CART_class, "./extra_tree_CART.rds")
cartModel <- readRDS("./extra_tree_CART.rds")
...
saveRDS(nBayes_all, "./extra_tree_nb.rds")
nbModel <- readRDS("./extra_tree_nb.rds")
...
saveRDS(predict_k215, "./extra_tree_knn.rds")
knnModel <- readRDS("./extra_tree_knn.rds")
...
saveRDS(net_wisc_bc, "./extra_tree_nn.rds")

net_wisc_bc <- readRDS('./extra_tree_nn.rds')
